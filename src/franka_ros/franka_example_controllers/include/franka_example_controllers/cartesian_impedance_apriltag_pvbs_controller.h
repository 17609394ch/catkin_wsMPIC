...
class CartesianImpedanceApriltagPvbsController : public controller_interface::MultiInterfaceController<
...
Eigen::Quaterniond orientation_target;
  Eigen::Vector3d position_base_target;
  Eigen::Quaterniond orientation_base_target;
  Eigen::Affine3d transformapriltag;

  Eigen::Vector3d position_apriltag;
  Eigen::Quaterniond orientation_apriltag;
  // Dynamic reconfigure
  ...
  void equilibriumPoseCallback(const geometry_msgs::PoseStampedConstPtr& msg);
    ...
    Eigen::Matrix<double, 6, 1> dt_error;
